...
public class Sandevistan : MonoBehaviour
{
	...
	[FormerlySerializedAs("EnableSandevistan")] [Header("Sandevistan Settings")]
	public bool EnableSandevistan = true;
	...
	public static void DoSlowMotion(float timescale = 0.1f, float duration = 2)
	{
		...
		if (Instance.EnableSandevistan == false)
		{
