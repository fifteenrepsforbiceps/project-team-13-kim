...
//     [HideInInspector] public CameraController MyPivotCamera;
...
//         public void UpdateRuntimeEventsCallbacks(CharacterBrain juchar)
//         {
//             //Run Event
...
//         }
//         public void SetEventListeners(CharacterBrain juchar)
//         {
...
//         }
//         public void RemoveEventListeners(CharacterBrain juchar)
//         {
...
//         MyPivotCamera = (IsArtificialIntelligence == false) ? FindObjectOfType<CameraController>() : null;
...
//
//         //Get JUHealth
//         if (TryGetComponent(out Health health)) { CharacterHealth = health; CharacterHealth.OnDeath.AddListener(DisableDamagers); }
//
//         // Get Inventory
...
//
//         if (CharacterHealth.CurrentHealth <= 0 && IsDead == false)
//         {
//             KillCharacter();
//         }
//
...
//             if (CharacterHealth == null) return;
//         }
//         CharacterHealth.TakeDamage(Damage, hitPosition);
//     }
...
//         }
//
//         CharacterHealth.CurrentHealth = 0;
//         IsDead = true;
//     }
