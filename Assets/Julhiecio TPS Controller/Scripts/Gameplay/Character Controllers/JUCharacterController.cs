...
namespace JUTPS
{
    ...
    public class JUCharacterController : JUCharacterBrain
    {
        ...
        public bool WalkOnRunButton = false;
        ...
        private void Start()
{
        ...
        public virtual void ControllerInputs()
        {
            ...
            if (JUInput.GetButtonDown(JUInput.Buttons.CrouchButton))
            {
                ...
                {
                    IsRunning = false; ReachedMaxSprintSpeed = false; CanSprint = true; 
            ...
            //Get Up
            if (IsCrouched == true && JUInput.GetButton(JUInput.Buttons.SprintButton))
            {
                _GetUp();
            }
            ...
            //Running
            if (JUInput.GetButton(JUInput.Buttons.SprintButton))
            {
            ...
            if (JUInput.GetButtonUp(JUInput.Buttons.SprintButton) && SprintOnRunButton == true)
            {
                IsSprinting = false;
            }
            ...
            //Auto Run
            if (AutoRun && IsCrouched == false && IsGrounded == true)
            {
            ...
            if (BlockFireModeOnPunching && (IsPunching || !IsWeaponEquiped))
            {
                FiringMode = false;
                FiringModeIK = false;
            }
        ...
        public virtual void SetAnimatorParameters()
        {
            ...
            if (AnimatorParameters.Sprinting != "") anim.SetBool(AnimatorParameters.Sprinting, IsSprinting);
            ...
            if (AnimatorParameters.ItemEquiped != "") anim.SetBool(AnimatorParameters.ItemEquiped, IsWeaponEquiped);
        ...
        protected virtual void Movement()
        {
            ...
            if (IsRolling)
            {
                // Curved Movement = 현재 방향에서 그냥 구름 (Roll) 
        ...
        protected virtual void LocomotionModeController()
        {
            switch (LocomotionMode)
            {
                case MovementMode.AwaysInFireMode:
                    // Always looking forward and in Fire Mode/Attack Mode, is used in FPS style
                    FiringMode = true;
                    //FiringModeIK = true;
                ...
                case MovementMode.JuTpsClassic:
                    ...
                    FiringMode = IsWeaponEquiped;
                    CurrentTimeToDisableFireMode = IsWeaponEquiped ? 0 : CurrentTimeToDisableFireMode;
                    break;
            }
        }
