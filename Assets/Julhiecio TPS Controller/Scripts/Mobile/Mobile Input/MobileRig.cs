...
namespace JUTPS.CrossPlataform
{
    ...
    public class MobileRig : MonoBehaviour
    {
        ...
        private void UpdateMobileButtons()
        {
            ...
            if (ShotButton != null) ShotButton.gameObject.SetActive(ShowShotButtonOnlyUsingItem ? JUGameManager.PlayerController.IsWeaponEquiped : true);
        ...
        private void RewriteGetButtonDown()
        {
            ...
            if (RunButton != null)
            {
                ...
                {
                    JUInput.RewriteInputButtonPressedDown(JUInput.Buttons.SprintButton, true);
                }
                else
                {
                    JUInput.RewriteInputButtonPressedDown(JUInput.Buttons.SprintButton, false);
                }
            }
        ...
        private void RewriteGetButton()
        {
            ...
            if (RunButton != null)
            {
                ...
                {
                    JUInput.RewriteInputButtonPressed(JUInput.Buttons.SprintButton, true);
                }
                else
                {
                    JUInput.RewriteInputButtonPressed(JUInput.Buttons.SprintButton, false);
                }
            }
        ...
        private void RewriteGetButtonUp()
        {
            ...
            if (RunButton != null)
            {
                ...
                {
                    JUInput.RewriteInputButtonPressedUp(JUInput.Buttons.SprintButton, true);
                }
                else
                {
                    JUInput.RewriteInputButtonPressedUp(JUInput.Buttons.SprintButton, false);
                }
            }
