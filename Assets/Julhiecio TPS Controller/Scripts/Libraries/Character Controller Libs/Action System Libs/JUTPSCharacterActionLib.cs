...
JUTPSCharacterActionLib.cs 파일은 캐릭터의 다양한 액션을 관리하기 위한 기본 구조를 제공합니다. JUTPSAction 클래스는 기본적인 캐릭터 컴포넌트들을 초기화하고 관리하는 역할을 하며, 
JUTPSAnimatedAction 클래스는 애니메이션 및 액션 상태를 세부적으로 제어하는 기능을 추가합니다. 
이를 통해 다양한 캐릭터 액션을 확장 가능하게 구현할 수 있습니다.
